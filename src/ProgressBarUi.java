...
public class ProgressBarUi extends BasicProgressBarUI {
    ...
    public ProgressBarUi() {
        try {
            bimage = ImageIO.read(this.getClass().getResource("/trace.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        Icons.WAIT.paintIcon(progressBar, g, offset2 - JBUIScale.scale(5), -JBUIScale.scale(3));
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        Icons.DASHIE.paintIcon(progressBar, g2, amountFull - JBUIScale.scale(5), -JBUIScale.scale(3));
        g2.translate(0, -(c.getHeight() - h) / 2);
